...
public class CandidatowebService {
	...
	public List<Candidato> listaCandidatosDristrital(){
		...
		candidatosDistrital.add(new Candidato("RENILSON ROMA	","AVANTE"));
		candidatosDistrital.add(new Candidato("RICARDO TOBÉ	","AVANTE"));
		candidatosDistrital.add(new Candidato("ROGÉRIO MORRO DA CRUZ	","AVANTE"));
		candidatosDistrital.add(new Candidato("SERGINHO DAMACENO	","AVANTE"));
		candidatosDistrital.add(new Candidato("SGT. SIMÕES - TOTO LEGAL	","AVANTE"));
		candidatosDistrital.add(new Candidato("SIMONE MAGALHÃES	","AVANTE"));
		candidatosDistrital.add(new Candidato("TÁCIO ROGÉRIO DOS RODOVIÁRIOS	","AVANTE"));
		candidatosDistrital.add(new Candidato("TATIANA REHBEIN	","AVANTE"));
		candidatosDistrital.add(new Candidato("TIA NAIR	","AVANTE"));
