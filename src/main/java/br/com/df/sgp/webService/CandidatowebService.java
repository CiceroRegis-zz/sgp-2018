...
public class CandidatowebService {
	...
	public Map<String, List<String>> listaCandidatosGovernador(){
		...
		String path = "E:\\Dev\\Projetos\\sgp-2018\\src\\main\\webapp\\pages\\csv\\candidatos_distrital.txt";
		String str = "";
	...
	/*public Map<String, List<String>> listaCandidatosDistrital() {
		...
		String path = "E:\\Dev\\Projetos\\sgp-2018\\src\\main\\webapp\\pages\\csv\\Lista-Candidatos-Deputado Distrital-DISTRITO FEDERAL-2018.xls";
		String str = "";
