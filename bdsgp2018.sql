...
id_log_cadastro SERIAL NOT NULL,
id_usuario int,
id_cadastro int,
dt_registro date,
...
id_grauInstrucao  SERIAL NOT NULL,
descricao varchar(255),
...
INSERT INTO usuario(nome, email, cpf, senha, celular, id_cidade, id_perfil, ativo) VALUES ('Cícero Regis', 'ciceroregis25@gmail.com','04292329184', md5('1995'),'6111111111',2,1,true);

INSERT INTO usuario(nome, email, cpf, senha, celular, id_cidade, id_perfil, ativo) 
VALUES ('José', 'ciceroregis25@gmail.com','04292329184', md5('1995'),'6111111111',3,3,true);
INSERT INTO usuario(nome, email, cpf, senha, celular, id_cidade, id_perfil, ativo) 
VALUES ('Joaoa', 'ciceroregis25@gmail.com','04292329184', md5('1995'),'6111111111',4,3,true);
INSERT INTO usuario(nome, email, cpf, senha, celular, id_cidade, id_perfil, ativo) 
VALUES ('MArias', 'ciceroregis25@gmail.com','04292329184', md5('1995'),'6111111111',5,3,true);
INSERT INTO usuario(nome, email, cpf, senha, celular, id_cidade, id_perfil, ativo) 
VALUES ('asdas', 'ciceroregis25@gmail.com','04292329184', md5('1995'),'6111111111',6,3,true);
INSERT INTO usuario(nome, email, cpf, senha, celular, id_cidade, id_perfil, ativo) 
VALUES ('vfvfvf', 'ciceroregis25@gmail.com','04292329184', md5('1995'),'6111111111',7,3,true);
INSERT INTO usuario(nome, email, cpf, senha, celular, id_cidade, id_perfil, ativo) 
VALUES ('cpcpcp', 'ciceroregis25@gmail.com','04292329184', md5('1995'),'6111111111',8,3,true);
INSERT INTO usuario(nome, email, cpf, senha, celular, id_cidade, id_perfil, ativo) 
VALUES ('sadasdas', 'ciceroregis25@gmail.com','04292329184', md5('1995'),'6111111111',10,3,true);
INSERT INTO usuario(nome, email, cpf, senha, celular, id_cidade, id_perfil, ativo) 
VALUES ('aasdadasdas', 'ciceroregis25@gmail.com','04292329184', md5('1995'),'6111111111',11,3,true);


INSERT INTO usuario(nome, email, cpf, senha, celular, id_cidade, id_perfil, ativo) 
VALUES ('José', 'ciceroregis25@gmail.com','04292329184', md5('1995'),'6111111111',1,3,true);
INSERT INTO usuario(nome, email, cpf, senha, celular, id_cidade, id_perfil, ativo) 
VALUES ('Joaoa', 'ciceroregis25@gmail.com','04292329184', md5('1995'),'6111111111',2,3,true);
INSERT INTO usuario(nome, email, cpf, senha, celular, id_cidade, id_perfil, ativo) 
VALUES ('MArias', 'ciceroregis25@gmail.com','04292329184', md5('1995'),'6111111111',3,3,true);
INSERT INTO usuario(nome, email, cpf, senha, celular, id_cidade, id_perfil, ativo) 
VALUES ('asdas', 'ciceroregis25@gmail.com','04292329184', md5('1995'),'6111111111',4,3,true);
INSERT INTO usuario(nome, email, cpf, senha, celular, id_cidade, id_perfil, ativo) 
VALUES ('vfvfvf', 'ciceroregis25@gmail.com','04292329184', md5('1995'),'6111111111',5,3,true);
INSERT INTO usuario(nome, email, cpf, senha, celular, id_cidade, id_perfil, ativo) 
VALUES ('cpcpcp', 'ciceroregis25@gmail.com','04292329184', md5('1995'),'6111111111',6,3,true);
INSERT INTO usuario(nome, email, cpf, senha, celular, id_cidade, id_perfil, ativo) 
VALUES ('sadasdas', 'ciceroregis25@gmail.com','04292329184', md5('1995'),'6111111111',7,3,true);
INSERT INTO usuario(nome, email, cpf, senha, celular, id_cidade, id_perfil, ativo) 
VALUES ('aasdadasdas', 'ciceroregis25@gmail.com','04292329184', md5('1995'),'6111111111',8,3,true);
...
/*
INSERT INTO candidatos(nomeCandidato,partidoCandidato,cargoCandidato) VALUES('Alberto Fraga','DEM','Governador');
...
CREATE TABLE candidatos_pesquisa(
    ...
    CONSTRAINT PK_Pesquisa PRIMARY KEY (idPesquisa, idCandidato),
    CONSTRAINT fK_pesquisa_pkIdCargo FOREIGN KEY (idPesquisa)
                    REFERENCES pesquisa_eleitoral (idPesquisa),

	CONSTRAINT fk_cargos FOREIGN KEY (idCandidato)
					REFERENCES candidatos(idCandidato)

);

INSERT INTO candidatos_pesquisa VALUES(1,7);
...
CREATE  TABLE pesquisa_eleitoral(
    ...
    idResponsavel int,
    idCandidato int ,
    nomeEntrevistado varchar(255) NOT NULL,
   endereco text,
   bairro text,
   cep text,
   telefone text,
   ...
   PACS text,
   outros text,
   CONSTRAINT pesquisaEleitoral_pkey primary key(idPesquisa),
   CONSTRAINT candidatos_pkey foreign key(idCandidato)
   REFERENCES candidatos (idCandidato)
...
idCandidato int auto_increment NOT NULL,
idPesquisa int  NULL,
 governador text,
	distrital text,
    federal text,
...
CONSTRAINT pesquisa_fkey FOREIGN KEY (idPesquisa)
                    REFERENCES pesquisa_eleitoral (idPesquisa)
